...
for file in "lib/jsfxr.js" "random.js" "audio.js" "font.js" "writer.js" "models.js" "3dsvg.js" "main.js"
do
  cat "${file}" >> "${jscat}"
done
...
# Add on the rest of the index file
echo -n '</script><meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"/></head><body><div id="wrapper"><svg id="svg" style="position:absolute; top:0px; left:0px; width:100%; height:100%;" xmlns="http://www.w3.org/2000/svg"><filter id="segblur"><feGaussianBlur stdDeviation="4" /></filter><g id="playfield" shaperendering="optimizeSpeed"></g><g id="hud"></g></svg></div></body></html>' >> "${indexcat}"
